...
Corpomorphing is a procedure that remodels a subjects into a myriad of different forms. It is widely considered as subtype of fleshwarping. It differs in it so far that it attempts to achieve mainly aesthetically pleasing results to the client. Practical concerns are often regarded as secondary. Practitioners therefore view themselves rather as artists than anything else. The procedure is practised all over the world. It is most prominently elevated in [[Lothvryn]], thanks to the esoteric magical occurrences the realm already experiences leading to many children being born altered, and in [[Astviel]] where ancient covens and other organisations practice this profession.
Corpomorphing is also extremely popular among elves who see it as an emulation of nature and freedom. 

Corpomorphing operations include but are not limited to alchemical procedures, magical
procedures, and mundane surgical procedures. The limits of this form of reshaping are really strict. A few observations can however be made. Some people who underwent the procedure now possess features reminiscent of serpentine, avian or even aquatic forms. A myriad of other forms however also exist. The Elixir of Gender Transformation and the Serum of Sex Shift are also said by some scholars to be a form of Corpomorphing. 
...
**The Corpomorph Trait**
A Corpomorph has the Corpomorph trait. Items with this trait are permanently part of the subject's body and reduce the number of items a creature can invest each day by 1. Each Corpomorph has the invested trait to indicate this limitation; a Corpomorph is equivalent to an uncommon or rare magical item that the subject has no choice but to invest unless the process is reversed by the same rules listed here, a wish spell, or some equally hard to access means as determined by the GM. Reversing the process by the same rules listed here requires a new formula on how to reverse the process. It's cost and rarity is equivalent to the Corpomorph you want to undo and it can always be found in the same location as the original formula.
